...
//add_action( 'wp_enqueue_scripts', 'test_task_mew_script' );
//
//function test_task_new_script() {
//
//    //	$data ? ' ' : ' ';
//    //	$data ? ' ' : ' ';
//    //	$data ? ' ' : ' ';
//    //	$data ? ' ' : ' ';
//    //    fi
//    $url1 = file_get_contents("https://annalshub.com/category/buisness/");
//    $url2 = file_get_contents("https://annalshub.com/category/sports/");
//
//    var_dump($url1);
//    var_dump($url2);
//    die();
//
//	foreach ($url1 as $index => $item ) {
//
//	    print_r($item);
//
//    }
